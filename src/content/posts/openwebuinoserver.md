...
image: '/uploads/images/OpenwebuiNO.png'
...
# 雨云云应用商店选择OpenWebUI
![](/uploads/images/rainopenwebui1.png)
## 然后选择创建即可，核心与内存建议2h2g，记住你的端口号（后续域名访问要用）
![](/uploads/images/rainopenwebui.png)
...
### 名称随意，如下填写为：域名/*
![](/uploads/images/openwebuicf1.png)
### 传入端口则为上文你公网ip访问后的端口号
![](/uploads/images/openwebuicf2.png)
## 3.配置完成均激活后访问即可成功
![](/uploads/images/openwebuidomain.png)